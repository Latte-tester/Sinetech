...
class SinetechYoutube : MainAPI() {
    override var mainUrl = "https://nyc1.iv.ggtyler.dev" // Hiç açılmazsa https://redirect.invidious.io/ bu adrese girip durumlarını kontrol ettikten sonra  url değiştirebiliriz.
        ...
        if (videoData != null) {
            callback(
                ExtractorLink(
                    "SinetechYoutube",
                    "SinetechYoutube",
                    "$mainUrl/api/manifest/dash/id/$videoId",
                    mainUrl,
